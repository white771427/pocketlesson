              ...
              <?php echo $this->Form->create('User',array('class'=>'bs-example form-horizontal')); ?>
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                  	<?php echo $this->Form->label('username',__('ユーザー名'),array('class' => 'col-lg-2 control-label','for'=>'username')); ?>
                  	<div class="col-lg-10">
                  ...
                  <div class="form-group">
                  	<?php echo $this->Form->label('password',__('パスワード'),array('class'=>'col-lg-2 control-label','for'=>'password')); ?>
