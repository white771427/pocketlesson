...
<div class="row">
	...
	<ul class="nav nav-tabs">
		<li class="disabled"><a>レッスン登録・編集</a></li>
		<li class="disabled"><a>チャプター登録・編集</a></li>
		...
		<div class="row">
			<div class="col-lg-6">
				<div class="well bs-component">
					...
					<?php echo $this->Form->create('Lesson',array('type'=>'file','class'=>'form-horizontal','url'=>array('controller'=>'MyLessons','action'=>'add'))); ?>
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<?php echo $this->Form->input('category_id',array('type'=>'select','options'=>$categories, 'empty'=>'選択してください','label'=>false,'div'=>false,'class'=>'form-control'));?>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<?php echo $this->Form->input('classification_id',array('type'=>'select','options'=>$classifications, 'empty'=>'選択してください','label'=>false,'div'=>false,'class'=>'form-control'));?>
							</div>
						</div>
